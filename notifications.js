...
// console.log('flexWrapper', flexWrapper);
...
function fetchNotifications(limit = 10) {
    ...
    const requestBody = {
        ...
        cmName: loginUser?.name,
        iSiteID: window.siteID,
        outputCasing: "pascal"
    };
    console.log("---window.requestBody", requestBody);
                ...
                fetch('https://devapi.apollo.business/api/Common/MarkNotificationAsRead', {
                    ...
                    .then(data => {
                        if (!data) {
                            ...
                            // Redirect to the URL from configData
...
window.topbarContainer = topbarContainer;
