...
document.addEventListener('DOMContentLoaded', function () {
    ...
    `;
        ...
        function saveNotificationConnectionId(connectionId) {
            const payload = {
            ...
            return fetch('https://devapi.apollo.business/api/Common/SaveNotificationConnectionId', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}` // Add token to headers
                ...
                .then(data => {
                    console.log('SaveNotificationConnectionId response:', data);
                    return data;
                })
                .catch(error => {
