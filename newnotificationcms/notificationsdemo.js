    ...
    `;
        ...
        (function () {
            if (!window._webSocketOverridden) { // Check if the override has already been applied
                ...
                window.WebSocket = function (url, protocols) {
                    ...
                    console.log('OriginalWebSocket', ws);
        ...
        async function start() {
            try {
                ...
                console.log("SignalR Connected.", window.webSocketId);
                AddConnectionToGroup();
                const result = await saveNotificationConnectionId(window.webSocketId);
            ...
            //         AddConnectionToGroup();
            //         const result = await saveNotificationConnectionId(connection.connectionId);
